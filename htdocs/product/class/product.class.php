    ...
    */
    ...
    public function update($id, $user, $notrigger = false, $action = 'update', $updatetype = false)
    {
        ...
        if ($result >= 0) {
            ...
            $sql .= ", lib_court = ".($this->lib_court != '' ? "'".$this->db->escape($this->lib_court)."'" : 'null');
            $sql .= ", ref_tissus_couleur = ".($this->ref_tissus_couleur != '' ? "'".$this->db->escape($this->ref_tissus_couleur)."'" : 'null');
            $sql .= ", icone_prod_1 = ".($this->icone_prod_1 != '' ? "'".$this->db->escape($this->icone_prod_1)."'" : 'null');
    ...
    public function fetch($id = '', $ref = '', $ref_ext = '', $barcode = '', $ignore_expression = 0, $ignore_price_load = 0, $ignore_lang_load = 0)
    {
		...
		$this->icone_prod_1          = $obj->icone_prod_1;
		$this->icone_prod_2          = $obj->icone_prod_2;
