...
/**
 * \file    test/phpunit/KenzaCustomizationFunctionalTest.php
...
/**
 * Class KenzaCustomizationFunctionalTest
 *
 ...
 *
 * @package Testkenzacustomization
 */
class KenzaCustomizationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modKenzaCustomization')->click();
		} else {
			// Disable the module
			$this->byHref('modKenzaCustomization')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/kenzacustomization/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('kenzacustomization/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/kenzacustomization/admin/about.php');
		$this->authenticate();
		return $this->assertContains('kenzacustomization/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('kenzacustomizationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modKenzaCustomization_KenzaCustomizationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modKenzaCustomization_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
