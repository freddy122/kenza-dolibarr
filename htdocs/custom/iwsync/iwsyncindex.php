...
/**
 *	\file       iwsync/iwsyncindex.php
 *	\ingroup    iwsync
 *	\brief      Home page of iwsync top menu
 */
...
$langs->loadLangs(array("iwsync@iwsync"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->iwsync->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("IWSYNCArea"));

print load_fiche_titre($langs->trans("IWSYNCArea"), '', 'iwsync.png@iwsync');
...
// Draft MyObject
if (! empty($conf->iwsync->enabled) && $user->rights->iwsync->read)
{
	$langs->load("orders");
