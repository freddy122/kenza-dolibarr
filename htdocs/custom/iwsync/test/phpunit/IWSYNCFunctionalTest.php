...
/**
 * \file    test/phpunit/IWSYNCFunctionalTest.php
 * \ingroup iwsync
 ...
 * @package Testiwsync
 */
class IWSYNCFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/iwsync/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('iwsync/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/iwsync/admin/about.php');
		$this->authenticate();
		return $this->assertContains('iwsync/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('iwsyncwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modIWSYNC_IWSYNCTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modIWSYNC_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
