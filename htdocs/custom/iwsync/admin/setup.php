...
} elseif ($action == 'specimen')
{
	...
	{
		$file = dol_buildpath($reldir."core/modules/iwsync/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file))
		{
			$filefound = 1;
...
} elseif ($action == 'setmod')
{
	...
	$tmpobjectkey = GETPOST('object');
	$constforval = 'IWSYNC_'.strtoupper($tmpobjectkey)."_ADDON";
...
dol_fiche_head($head, 'settings', '', -1, "iwsync@iwsync");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("IWSYNCSetupPage").'</span><br><br>';
...
if ($action == 'edit')
{
	...
	print '<br><div class="center">';
        print '<input class="button" type="submit" value="'.$langs->trans("Saveiw").'">';
	print '<a href="'.$_SERVER["PHP_SELF"].'"><input class="button" type="button" value="'.$langs->trans("Canceliw").'"></a>';
	print '</div>';
