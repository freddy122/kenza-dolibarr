...
class BCGDrawing
{
    ...
    /**
     * Creates a drawing surface by indicating where to save the image and its background color.
     *
     * @param string filename File to save on disk.
     * @param BCGColor $color Background color.
     */
