...
if(!empty($numberofsticker) && !empty(GETPOST("forbarcode")) && empty(GETPOST("submitproduct"))) {
    ...
    if (GETPOST('printproduct'))
    {
        ...
        for($i=1;$i<=$numberofsticker;$i++){
            ...
            $marginFirstRow = "";
            if($i == 1){
                $marginFirstRow = "margin-top:-1mm;";
            }elseif($i == $numberofsticker){
                $marginFirstRow = "margin-top:-2mm;";
            }else{
                $marginFirstRow = "margin-top:-2mm;";
            }
            $htmlDataToPrint .= "<div style='width:".$tableWidth.";height:28mm;".$marginFirstRow." ".$breakbefore.";margin'>";
            if($isShowLabel == 1){
                $htmlDataToPrint .= "<div>";
                //$htmlDataToPrint .= "<div>";
            ...
            if($isShowLabel == 1){
                ...
                $htmlDataToPrint .= "<div class='carte_metisse_style' style='".$style_not_firefox_carte_metisse."'>Carte metisse: ".price($carteMetisse)." €</div>";
                //$htmlDataToPrint .= "</div>";
                //$htmlDataToPrint .= "</div>";
            }
