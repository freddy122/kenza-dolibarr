...
if(!empty($numberofsticker) && !empty(GETPOST("forbarcode")) && empty(GETPOST("submitproduct"))) {
    ...
    if (GETPOST('printproduct'))
    {
        ...
        for($i=1;$i<=$numberofsticker;$i++){
            ...
            $htmlDataToPrint .= "<div style='width:".$tableWidth.";height:28mm;".$breakbefore."'>";
            if($isShowLabel == 1){
                $htmlDataToPrint .= "<div>";
                //$htmlDataToPrint .= "<div>";
                ...
                if(!empty($resParentId)){
                    ...
                    $divCustomUnderLabel = "font-size:14px;";
                    
                    if(strlen($prodPrincipaleName) >= 20 ){
                        // font-size : 17px
                        $divCustomLabel = "font-size:16px;width:51%;";
                    }
                    if(!empty($arrCombinationss)){
                        if(strlen(implode(', ',$arrCombinationss)) >= 30 ){
                            // font-size : 14px
                            $divCustomUnderLabel = "font-size:14px;width:55%;";
                        }
                    }
                    $arrCombinationOk =[];
                    ...
                    $marginFirstRow = "";
                    if($i == 1){
                        $marginFirstRow = "margin-top:5px;";
                    }elseif($i == $numberofsticker){
                        $marginFirstRow = "margin-top:-30px;";
                    }else{
                        $marginFirstRow = "margin-top:-10px;";
                    }
                    $htmlDataToPrint .= "<div style='".$divCustomLabel."text-transform:uppercase;font-family: Arial, Helvetica, sans-serif;font-weight:bold;margin-bottom: -7px;".$marginFirstRow."'>".$_POST['product_name']."</div>";
                    $htmlDataToPrint .= "<div style='".$divCustomUnderLabel."margin-top: 5px;font-family: Arial, Helvetica, sans-serif;margin-bottom: -2px;'>".(!empty($arrCombinationOk) ? implode(', ',$arrCombinationOk) : "")."</div>";
                }else{
            ...
            if($producttmp->product_type_txt == "fab" && $isShowLabel != 1){
                ...
                $htmlDataToPrint .= "<div style='width:40%;display:flex'>";
                $htmlDataToPrint .= "<div><img src='data:image/png;base64,".$imgDataFromPng."' style='".$style_not_firefox_img."'></div>";
                //$htmlDataToPrint .= "</div>";
            }
            if($isShowLabel == 1){
                ...
                $htmlDataToPrint .= "<div style='font-weight:bold;font-family: Arial, Helvetica, sans-serif;font-size:22px;'>".$priceTTc. " €"."</div>";
                $htmlDataToPrint .= "</div>";
            }
            $htmlDataToPrint .= "</div>";
            if($isShowLabel == 1){
        ...
        <script type='text/javascript'>
            ...
            function showPrint() {
                ...
                printWindow.document.write('</head><body><div style="width:437px;margin-left:-5px;">');
