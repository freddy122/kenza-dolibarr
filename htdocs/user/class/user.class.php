...
class User extends CommonObject
{
	...
	public $fk_warehouse;
	public $last_limit_product_list;
	...
	public function fetch($id = '', $login = '', $sid = '', $loadpersonalconf = 0, $entity = -1, $email = '')
	{
		...
		if ($result)
		{
			...
			if ($obj)
			{
				...
				$this->last_limit_product_list = $obj->last_limit_product_list;
	...
	public function update($user, $notrigger = 0, $nosyncmember = 0, $nosyncmemberpass = 0, $nosynccontact = 0)
	{
		...
		$this->last_limit_product_list = trim(empty($this->last_limit_product_list) ? '' : $this->last_limit_product_list);
		...
		$sql .= ", last_limit_product_list = ".($this->last_limit_product_list ? "'".$this->db->escape($this->last_limit_product_list)."'" : "null");
